...
/*
arr[left] ~ arr[right] 범위에서 원소 하나를 피벗으로 선택하는 함수
*/
...
/*
   배열의 두 원소 arr[indexA] 와 arr[indexB]를 swap해주는 함수
*/
...
/* arr[left] ~ arr[[right] 범위를 피봇 기준으로 좌우를 나눈다
...
/*
arr[left] ~ arr[right] 범위를 정렬해주는 함수
*/
